...
import li.bryt.tools.image_server.modules.utils.MockClient;
import li.bryt.tools.image_server.modules.utils.RESTfulResponse;
...
public class MainModuleTest extends Assert {
	...
	public static void initClass() throws Exception {
		...
		filter.setInitParameter("modules", "li.bryt.tools.image_server.modules.MainModule");
